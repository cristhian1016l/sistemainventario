...
<head>
    ...
    <title>Lista de trabajadores por cargo</title>
    <style>
        body {
            margin: -30px;
...
<body>
    ...
    <div>
        ...
        <p style="margin-top: -8px; font-family: 'Inter', sans-serif; font-size: 20px; font-weight: bold; text-align: center;">LISTADO POR CARGO DE "{{ $type[0]->name }}"</p>
        <br>                 
        ...
        <table id="table">
            <thead>
                <tr>
                    ...
                    <td>
                        <span style="font-family: 'Inter', sans-serif; font-size: 11.5px; font-weight: bold; text-align: center;">Nombres</span>
                    </td>
                    <td>
